...
<div class="max-w-[1320px] mx-auto px-6 pt-3 pb-8"
    ...
    <div class="ds-card p-[18px] mb-4 grid gap-4" style="grid-template-columns: 1fr auto">
        ...
        <div class="flex flex-col gap-2 min-w-[200px]">
                    ...
                    @if($canManage)
                        <div class="flex flex-wrap items-center gap-2">
                            ...
                            <span class="text-[11.5px] text-fg-3">
                                Уйдёт на {{ $req->client_email ?: '— адреса нет' }} с вашей почты,
                                с подписью и КП в PDF; заявка станет «КП отправлено»
                            </span>
                        </div>
                    @endif
                </div>
            ...
            {{-- Пометка «это запрос поставщику» теперь делается через
    ...
    <div class="border border-border border-t-0 rounded-b-md bg-surface-2 p-3.5">
        ...
        @switch($tab)
            ...
            @case('items')
                ...
                {{-- Запросы поставщикам — в табе «Поставщики» (SupplierDispatchPanel). --}}
    ...
    {{-- Лайтбокс просмотра картинок — общий с почтой и перепиской с поставщиком:
         масштаб, поворот и перетаскивание живут в одном месте. --}}
