<div class="space-y-4">
    ...
    <div class="ds-card">
        ...
        <div class="px-4 py-2 text-[11px] text-fg-4 border-t border-border-subtle">
            «~» — приблизительная оценка времени по таймстампам действий (для дней до включения точного heartbeat-учёта присутствия). «Письма» — отправленные через систему (составленные в CRM).
        </div>
    </div>
