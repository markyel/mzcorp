        ...
        <div class="ds-card-body overflow-x-auto">
            ...
            @if($lrExcluded > 0)
                <p class="mt-3 text-[11.5px] text-fg-3">
                    ...
                    авто-триаж (LLM/cron: не наша тематика, спам, дубли, парсер без позиций) и разовая предзапусковая заливка. Ручные решения менеджера и авто-закрытия реальных потерь (молчит после КП, неоплаченный счёт) остаются. Фильтр применён во всех блоках аналитики.
                </p>
            @endif
        </div>
    </div>
