@php
    ...
    if ($user?->hasRole('admin')) {
        ...
        // «Маркетинг» — доступы к рекламным кабинетам, план, журнал работ и
        // ежемесячный отчёт по договору. Только админ: внутри пароли.
        $navLinks[] = ['route' => 'marketing.index', 'label' => 'Маркетинг', 'pattern' => 'marketing.*'];
        // «Директ» — управление рекламой складских позиций через API.
        $navLinks[] = ['route' => 'direct.index', 'label' => 'Директ', 'pattern' => 'direct.*'];
    }
