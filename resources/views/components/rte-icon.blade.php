@props(['name'])
@php
    // Lucide-иконки (MIT) для панели редактора письма. 16px, stroke=currentColor.
    $paths = [
        ...
        'merge' => '<rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 12h18"/><path d="M12 3v18"/><path d="m9 9 6 6"/><path d="m15 9-6 6"/>',
        'x' => '<path d="M18 6 6 18"/><path d="m6 6 12 12"/>',
        'check' => '<path d="M20 6 9 17l-5-5"/>',
    ];
@endphp
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" {{ $attributes->merge(['class' => 'rte-ico']) }}>{!! $paths[$name] ?? '' !!}</svg>
