 ...
 *
 * Возвращает 4 типа (соответствуют outbound DetectorType):
...
письма из 4 фиксированных категорий по содержимому subject + body + именам
...
4. other — обычная переписка, не вызывающая авто-перехода статуса.
   • «Добрый день, мы получили ваш запрос, в работе», «уведомление о
     заказе принят», «спасибо за обращение», заглушки.
   • Письма без явных сигналов КП/счёта/уточнения.
