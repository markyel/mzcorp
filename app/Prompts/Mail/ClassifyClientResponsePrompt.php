...
3. invoice_request — клиент ЯВНО согласовал КП и просит ВЫСТАВИТЬ СЧЁТ.
   ...
   • ВОПРОС о наличии / возможности поставки (часто по НОВОЙ позиции):
     «У вас есть возможность поставки …?», «Есть в наличии …?», «Можете
     поставить …?», «Почём …?» — это ЗАПРОС/уточнение, а НЕ просьба выставить
     счёт, даже если в теме есть номер КП. Вопрос о наличии ≠ счёт.
   • Клиент сообщает об УЖЕ совершённой ОПЛАТЕ: «счёт оплатили», «оплату
     отправили / провели», «деньги перечислили / ушли», «ожидайте поступлений»,
     «платёжку прикладываю» — счёт УЖЕ выставлен, это ПОДТВЕРЖДЕНИЕ ОПЛАТЫ
     (post-sale), а НЕ просьба выставить счёт. Это НЕ invoice_request.
