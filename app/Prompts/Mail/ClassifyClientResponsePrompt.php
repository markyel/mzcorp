...
3. invoice_request — клиент ЯВНО согласовал КП и просит ВЫСТАВИТЬ СЧЁТ.
   ...
   Инструкция по доставке/адресу/реквизитам САМА ПО СЕБЕ — это уточнение к
   КП, а не согласие оформить счёт. Счёт запрашивают отдельной явной фразой.
   Если в письме И правка, И явное «выставите счёт» — тогда invoice_request.
