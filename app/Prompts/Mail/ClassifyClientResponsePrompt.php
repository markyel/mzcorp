...
4. decline_with_reason — клиент ОКОНЧАТЕЛЬНО отказывается от заявки,
   ...
   альтернативу) — это negotiation/clarification, intent = unclear. Только
   «спасибо, не нужно / отказываемся / закрываем вопрос / нашли в другом
   месте без обсуждения» — это decline.
