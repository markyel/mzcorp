...
class MailRouter
{
    ...
    {
        // Цепочка ранних решений (RoutingPipeline, порядок — контракт): служебные
        // уведомления, rfq@, исходящие, не-inbound, петля пересылки, ящик
        // снабжения, стоп-лист, копия из другого ящика. Остаток ниже переносится
        // в цепочку следующими шагами (strangler, 2026-09-09).
