...
class PostSaleFulfillmentDetector
{
    ...
    private const INVOICE_REQUEST_VERB_RE = '/(выстав\w+|пришл\w+|присла\w+|вышл\w+|выслать|оформ\w+|подготов\w+|обнов\w+|дайте|дать|нужен|нужно|сдела\w+)\s+(пожалуйста\s+)?сч[её]т/u';
