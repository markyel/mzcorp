...
PROMPT;
    ...
    private function parseItemsFromPhotoMarkings(
        ...
        $intro .= "ПРАВИЛА ИЗВЛЕЧЕНИЯ:\n"
            ...
            . "    - угадывать «правдоподобный» бренд по типу детали из общих\n"
            . "      знаний («русская кнопка лифта → ЩЛЗ», «двигатель → Siemens»);\n"
            . "    - использовать как brand клиента/отправителя/домен почты;\n"
            . "    - дописывать расшифровку («ЩЛЗ (Щербинский Лифтовый Завод)»).\n"
