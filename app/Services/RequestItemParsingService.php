...
PROMPT;
    ...
    private function parseItemsFromPhotoMarkings(
        ...
        $intro .= "ПРАВИЛА ИЗВЛЕЧЕНИЯ:\n"
            ...
            . "  Sigma, Siemens, Wittur, Vega, Schneider, Telemecanique, ЩЛЗ, ARO и т.п.).\n"
            . "  Бренд часто стоит рядом с логотипом или в углу шильдика.\n"
        ...
        $intro .= "═══ ОБЪЕДИНЕНИЕ ТЕКСТ + ФОТО (КРИТИЧНО) ═══\n"
            . "Текст письма и фото — ДВА ИСТОЧНИКА ДАННЫХ для одной позиции.\n"
            . "Текст обычно даёт ИМЯ («Концевой выключатель») и КОЛИЧЕСТВО («10 шт.»),\n"
            . "но НЕ артикул. Фото-шильдик даёт АРТИКУЛ и БРЕНД.\n\n"
            . "ЖЁСТКОЕ ПРАВИЛО: если позиция создана из текстового списка И ей\n"
            . "сопоставлен image_index с фото, где `has_readable_marking=true` —\n"
            . "ОБЯЗАТЕЛЬНО прочти артикул с шильдика и положи в `article`.\n"
            . "Также прочти бренд (название/логотип производителя) в `brand`.\n"
            . "НЕ возвращай article=null если на привязанном фото видна\n"
            . "читаемая маркировка с буквенно-цифровым кодом — это явная ошибка.\n\n"
            . "Если читаешь шильдик и есть несколько кандидатов (PRODUCT CODE,\n"
            . "TYPE, BATCH, S/N, дата) — артикул это код возле подписи PRODUCT\n"
            . "CODE / TYPE / ART / REF / MODEL. S/N, BATCH, lot, дата — НЕ артикул.\n"
            . "Если подписей нет, артикул — это самый крупный и контрастный\n"
            . "буквенно-цифровой код на главной строке шильдика, обычно сразу\n"
            . "под названием товара или возле логотипа бренда.\n\n"
            . "Пример (типичный кейс): в письме «1. Концевой выключатель — 10 шт.»,\n"
            . "на фото closeup шильдика «CR400-NF Aceswitch / NChangjiang / IP65 /\n"
            . "AC-15: 230V 4A / DC-13: 24V 1A / tb No:1011 / KG03082E».\n"
            . "Правильный item: name=«Концевой выключатель», brand=«NChangjiang»,\n"
            . "article=«CR400-NF», qty=10, image_index=0.\n"
            . "(«tb No:1011», «KG03082E» — это lot/serial, в article НЕ кладём.)\n\n"
