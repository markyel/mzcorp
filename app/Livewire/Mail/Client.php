...
class Client extends Component
{
    ...
    /**
     * Показывать всю переписку развёрнутой: тела всех писем треда подряд, а не
     * одно выбранное. Держится до выключения — кто читает треды целиком, тот
     * читает так всегда; выбор письма в списке режим не сбрасывает.
     */
    public bool $expandThread = false;

    public function toggleExpandThread(): void
    {
