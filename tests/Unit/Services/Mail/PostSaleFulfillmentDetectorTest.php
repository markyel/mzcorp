...
class PostSaleFulfillmentDetectorTest extends TestCase
{
    ...
    public static function citedQuoteCases(): array
    {
        return [
            ...
            'M-2026-17264 доплатим доставку' => ['Re: АНО МКК, покупка запчастей (368530)', 'Добрый день, Владимир! Мы доплатим доставку', true, false],
            ...
            'счёт и доставку оплатим сами' => ['Re: КП 361950', 'Выставьте счёт на 2 шт, доставку оплатим сами', true, true],
