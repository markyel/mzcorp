...
|---|---|---|---|
| 1.1 | Документация: `CLAUDE.md`, `MEMORY.md`, `README.md` | новое | в работе |
| 1.2 | Auth + 4 роли через `spatie/laravel-permission` | новое | pending |
| 1.3 | Модели email-инфры: `Mailbox`, `EmailMessage`, `EmailAttachment` + миграции | новое | pending |
